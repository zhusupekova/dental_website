      ...
      <main>
        ...
        <section className="section content-split">
          <div className="content-panel">
            ...
            <p>{clinic.name} создана как клиника, где медицинское качество не отделяется от человеческого отношения. Мы не торопим пациента, заранее обсуждаем условия и объясняем каждое решение.</p>
            <ul>
              <li>Честный план лечения и понятные условия.</li>
